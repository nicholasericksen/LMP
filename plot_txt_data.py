...
from get_stokes import get_stokes
...
s0, s1, s2, s3 = get_stokes(x_radians, y)
...
integrandA = y
integrandB = y*np.sin(2*x_radians)
...
print "S0 (Simpsons): " , norm_stokes_S0
print "S1 (Simpsons): " , norm_stokes_S1
print "S2 (Simpsons): " , norm_stokes_S2
print "S3 (Simpsons): " , norm_stokes_S3
...
ax.scatter(norm_stokes_S1, norm_stokes_S2, norm_stokes_S3, color="g", s=100)
